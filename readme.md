...
- Candidate generation uses heuristic matching rather than semantic embeddings.
- Investigations are executed sequentially.
- JSON storage is not intended for concurrent production workloads.
- Recommendations depend on the quality of the underlying LLM.
...
AI coding assistants (Claude and ChatGPT) were used to accelerate implementation, generate boilerplate, review architecture, and refine documentation.

All generated code was reviewed, modified where necessary, tested locally, and is understood by the author.